...
const mezzi = ref([
  {
    id: 1,
    nome: 'Fiat Ducato Maxi',
    categoria: 'veicolo',
    modello: 'Ducato 35 Maxi',
    anno: 2021,
    targa: 'FG123AB',
    ...
    prossimaRevisione: '2024-03-15',
    note: 'Veicolo principale per trasporti',
    manutenzioni: [
      { id: 1, tipo: 'Tagliando', data: '2024-01-15', costo: 350, fornitore: 'Officina Rossi' },
      { id: 2, tipo: 'Cambio gomme', data: '2023-11-20', costo: 480, fornitore: 'Gommista Centro' }
    ]
  },
  {
    id: 2,
    nome: 'Escavatore CAT 320D',
    categoria: 'attrezzatura',
    modello: '320D',
    anno: 2019,
    targa: 'CAT320D001',
    chilometraggio: 2350, // ore
    stato: 'disponibile',
    costoMensile: 1200,
    cantiereAttuale: null,
    prossimaRevisione: '2024-04-10',
    note: 'Escavatore per lavori pesanti',
    manutenzioni: [
      { id: 3, tipo: 'Manutenzione programmata', data: '2024-01-10', costo: 850, fornitore: 'CAT Service' }
    ]
  },
  {
    id: 3,
    nome: 'Sega Circolare Festool',
    categoria: 'utensile',
    modello: 'TS 55 REBQ-Plus',
    anno: 2022,
    targa: 'FT55001',
    chilometraggio: 120, // ore
    stato: 'disponibile',
    costoMensile: 45,
    cantiereAttuale: null,
    prossimaRevisione: '2024-06-01',
    note: 'Sega di precisione per finiture',
    manutenzioni: []
  },
  {
    id: 4,
    nome: 'Pialla Industriale SCM',
    categoria: 'macchinario',
    modello: 'NOVA S520',
    anno: 2020,
    targa: 'SCM520001',
    chilometraggio: 890, // ore
    stato: 'manutenzione',
    costoMensile: 280,
    cantiereAttuale: null,
    prossimaRevisione: '2024-02-28',
    note: 'In manutenzione straordinaria',
    manutenzioni: [
      { id: 4, tipo: 'Sostituzione lame', data: '2024-01-20', costo: 120, fornitore: 'Utensili Pro' }
    ]
  },
  {
    id: 5,
    nome: 'Iveco Daily 35C',
    categoria: 'veicolo',
    modello: 'Daily 35C15',
    anno: 2020,
    targa: 'IV456CD',
    ...
    costoMensile: 580,
    cantiereAttuale: null,
    prossimaRevisione: '2024-05-20',
    note: 'Secondo veicolo da trasporto',
    manutenzioni: []
  },
  {
    id: 6,
    ...
    anno: 2023,
    targa: 'MK484001',
    chilometraggio: 45, // ore
    stato: 'in-uso',
    costoMensile: 25,
    cantiereAttuale: 'Villa Rossi',
    prossimaRevisione: '2024-08-15',
    note: 'Trapano a batteria professionale',
    manutenzioni: []
  }
])
